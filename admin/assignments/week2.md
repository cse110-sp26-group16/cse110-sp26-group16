...
- [x] Hold the kickoff meeting (define roles, rules, process)
- [x] Write meeting notes in Markdown — include: team name, type, attendance, time/place, agenda, decisions + reasoning, end time
- [x] Name the file `mmddyy-kickoff.md` (e.g. `040826-kickoff.md`)
- [x] Push notes to `/admin/meetings/`
...
- [x] Create `/admin/team.md` with: team name, brand, values, and a roster with a bio + GitHub link for each member
- [x] Link to `team.md` from `README.md` in the root

### Team intro video _(graded — bonus if TA picks yours)_

- [x] Record a team intro video — max 2.5 min, MP4 or Quicktime
- [x] Place it at `/admin/videos/teamintro.mp4` (compress if needed)
